...
def upgrade() -> None:
    ...
    sa.Column('condition', postgresql.ENUM('NEW', 'LIKE_NEW', 'VERY_GOOD', 'GOOD', 'FAIR', 'WORN', 'DAMAGED', 'UNUSABLE', name='bookcondition', create_type=False), nullable=False),
    ...
    sa.Column('account_type', postgresql.ENUM('ADMIN', 'LIBRARIAN', 'BORROWER', name='accounttype', create_type=False), nullable=False),
    sa.PrimaryKeyConstraint('id')
    )
